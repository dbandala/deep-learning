    ...
    def run(self):
        ...
        try:
            ...
            app = FoodRecognitionApp(
                ...
                show_all_masks=True  # Show all objects
            )
            app.run()
        except ImportError:
            print("❌ Could not import FoodRecognitionApp. Please ensure all dependencies are installed.")
            if self.install_dependencies():
                print("Please run this script again after installing dependencies.")
            return
